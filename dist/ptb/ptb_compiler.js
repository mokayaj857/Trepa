 ...
 */
export function buildGuardedWithdrawCall(paymentPayload) {
    ...
    const actionHashHex = trepaExt.action_hash;
    if (!actionHashHex)
        throw new Error("paymentPayload missing trepa.action_hash extension");
